...
const HeaderComponent = () => {
	...
	return (
		<div className=" px-5  bg-gradient-to-b from-black w-full flex justify-between fixed top-0 left-0  z-20">
			...
			<ul className="flex space-x-4 ml-10 mr-8 items-center text-white ">
				<li>
					<div className="relative flex  justify-center overflow-hidden bg-gradient-to-brp-6 ">
						<div className="bg-gray-800  relative rounded-3xl pt-1 pb-1 shadow-2xl ring-1 ring-gray-300/5 sm:mx-auto sm:max-w-xl sm:px-10 opacity-50">
							<div className="mx-auto max-w-md">
								<form action="" className="relative mx-auto w-max">
									<input
										type="search"
										className="peer cursor-pointer relative z-10 h-10 w-6 rounded-full border bg-transparent pl-10 outline-none  focus:w-full focus:cursor-text focus:border-gray-300 focus:pl-16 focus:pr-4"
									/>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										className="absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent stroke-gray-200 px-3.5 peer-focus:border-gray-200 peer-focus:stroke-gray-200"
										fill="none"
										viewBox="0 0 24 24"
										stroke="currentColor"
										stroke-width="2"
